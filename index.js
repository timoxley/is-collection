...
module.exports = function isCollection(obj) {
  ...
  switch (type) {
    ...
    case 'object':
      console.log('isNodeList', isNodeList(obj))
...
function isNodeList(nodes) {
  console.log(" /^\[object (NodeList)\]$/.test(Object.prototype.toString.call(nodes))",  /^\[object (NodeList)\]$/.test(Object.prototype.toString.call(nodes)))
